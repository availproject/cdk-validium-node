...
// SequenceBatchesValidium is a paid mutator transaction binding the contract method 0x652b0018.
//
// Solidity: function sequenceBatchesValidium((bytes32,bytes32,uint64,bytes32)[] batches, uint64 maxSequenceTimestamp, uint64 initSequencedBatch, address l2Coinbase, (bytes32[],bytes32[],bytes32,uint256,bytes32,bytes32,bytes32,uint256) dataAvailabilityMessage) returns()
func (_Polygonzkevm *PolygonzkevmTransactor) SequenceBatchesValidium(opts *bind.TransactOpts, batches []PolygonValidiumEtrogValidiumBatchData, maxSequenceTimestamp uint64, initSequencedBatch uint64, l2Coinbase common.Address, dataAvailabilityMessage IAvailBridgeMerkleProofInput) (*types.Transaction, error) {
...
//
// Solidity: function sequenceBatchesValidium((bytes32,bytes32,uint64,bytes32)[] batches, uint64 maxSequenceTimestamp, uint64 initSequencedBatch, address l2Coinbase, (bytes32[],bytes32[],bytes32,uint256,bytes32,bytes32,bytes32,uint256) dataAvailabilityMessage) returns()
func (_Polygonzkevm *PolygonzkevmSession) SequenceBatchesValidium(batches []PolygonValidiumEtrogValidiumBatchData, maxSequenceTimestamp uint64, initSequencedBatch uint64, l2Coinbase common.Address, dataAvailabilityMessage IAvailBridgeMerkleProofInput) (*types.Transaction, error) {
...
//
// Solidity: function sequenceBatchesValidium((bytes32,bytes32,uint64,bytes32)[] batches, uint64 maxSequenceTimestamp, uint64 initSequencedBatch, address l2Coinbase, (bytes32[],bytes32[],bytes32,uint256,bytes32,bytes32,bytes32,uint256) dataAvailabilityMessage) returns()
func (_Polygonzkevm *PolygonzkevmTransactorSession) SequenceBatchesValidium(batches []PolygonValidiumEtrogValidiumBatchData, maxSequenceTimestamp uint64, initSequencedBatch uint64, l2Coinbase common.Address, dataAvailabilityMessage IAvailBridgeMerkleProofInput) (*types.Transaction, error) {
	return _Polygonzkevm.Contract.SequenceBatchesValidium(&_Polygonzkevm.TransactOpts, batches, maxSequenceTimestamp, initSequencedBatch, l2Coinbase, dataAvailabilityMessage)
}
