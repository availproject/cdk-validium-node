...
func (_Etrogpolygonzkevm *EtrogpolygonzkevmTransactor) SequenceBatchesValidium(opts *bind.TransactOpts, batches []PolygonValidiumEtrogValidiumBatchData, maxSequenceTimestamp uint64, initSequencedBatch uint64, l2Coinbase common.Address, dataAvailabilityMessage IAvailBridgeMerkleProofInput) (*types.Transaction, error) {
...
//
// Solidity: function sequenceBatchesValidium((bytes32,bytes32,uint64,bytes32)[] batches, uint64 maxSequenceTimestamp, uint64 initSequencedBatch, address l2Coinbase, (bytes32[],bytes32[],bytes32,uint256,bytes32,bytes32,bytes32,uint256) dataAvailabilityMessage) returns()
func (_Etrogpolygonzkevm *EtrogpolygonzkevmSession) SequenceBatchesValidium(batches []PolygonValidiumEtrogValidiumBatchData, maxSequenceTimestamp uint64, initSequencedBatch uint64, l2Coinbase common.Address, dataAvailabilityMessage IAvailBridgeMerkleProofInput) (*types.Transaction, error) {
...
//
// Solidity: function sequenceBatchesValidium((bytes32,bytes32,uint64,bytes32)[] batches, uint64 maxSequenceTimestamp, uint64 initSequencedBatch, address l2Coinbase, (bytes32[],bytes32[],bytes32,uint256,bytes32,bytes32,bytes32,uint256) dataAvailabilityMessage) returns()
func (_Etrogpolygonzkevm *EtrogpolygonzkevmTransactorSession) SequenceBatchesValidium(batches []PolygonValidiumEtrogValidiumBatchData, maxSequenceTimestamp uint64, initSequencedBatch uint64, l2Coinbase common.Address, dataAvailabilityMessage IAvailBridgeMerkleProofInput) (*types.Transaction, error) {
	return _Etrogpolygonzkevm.Contract.SequenceBatchesValidium(&_Etrogpolygonzkevm.TransactOpts, batches, maxSequenceTimestamp, initSequencedBatch, l2Coinbase, dataAvailabilityMessage)
}
